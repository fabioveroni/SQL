...
-- NOTAS CANCELADAS NO MES EXCETO O MES
...
-- RE.ESTNCODIGO,
  ...
  -- SYSDATE,
    ...
    */
    ...
    AND NF.DATA_CANC>='01-12-2021' AND NF.DATA_CANC<'01-01-2022' -- AND NF.DATA_CANC<'01-08-2021'
    -- AND FCAR.CRCDRECEBIMENTO>='01-07-2021' AND FCAR.CRCDRECEBIMENTO<'01-08-2021'
    AND NF.DATA_EMISSAO<'01-12-2021' 
    -- AND FCAR.CRCDRECEBIMENTO>='01-07-2021' --AND FCAR.CRCDRECEBIMENTO<'01-08-2021'
    AND RF.SITUACAO='C'
 ...
 -- SELECT * FROM RCR.FATURA WHERE NUMERO=44481
